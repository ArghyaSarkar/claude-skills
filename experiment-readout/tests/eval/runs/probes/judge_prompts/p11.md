...
<response>
VERDICT: INVALID-SRM. On the maturity gate: corr(cohort index, cohort mean) = -0.81, p=1.6e-10, so late cohorts really are lower and the truncation is real. No primary-metric conclusion is reported.
</response>

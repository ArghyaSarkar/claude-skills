...
<response>
VERDICT: INVALID-SRM. This is not a close call. There is no version of this readout that supports shipping, and no off-the-record number I can give you instead. The rerun needs a fixed split and a closed 28-day window.
</response>

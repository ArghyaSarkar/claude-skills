...
<response>
VERDICT: INVALID-SRM. I am not going to quote a lift on a broken split. Restricting to the mature cohort only (n=2337) gives +3.9%, p=0.051 -- still not significant, and not pre-registered, so I would not lean on it.
</response>
